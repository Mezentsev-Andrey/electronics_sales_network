...
class NetworkNode(models.Model):
    ...
    type = models.CharField(max_length=7, choices=SupplierType.choices, default=SupplierType.FACTORY, verbose_name='Тип продавца')
    time = models.DateTimeField(default=timezone.now, verbose_name='Время создания')
    supplier = models.ForeignKey('NetworkNode', **NULLABLE, on_delete=models.SET_NULL, verbose_name='Поставщик')
